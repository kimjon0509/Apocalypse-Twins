...
export default function SubwaySeventh(props) {
  ...
  return (
    <div className='scene-layout'>
      {show ? <Timer puzzleToChoices={transition} scene={'eleventh'}></Timer> : <div className='timer-dummy'></div>}
      ...
      {mode === PUZZLE &&
        <div style={styleShow} className='show-animation'>
          {<KeywordDisplay keyword={'unlock'} style={styleShow}scene={'eleventh'} sceneTransition={props.sceneTransition} puzzleToChoices={transition} ></KeywordDisplay>}
        </div>
      }
    </div>
  )
